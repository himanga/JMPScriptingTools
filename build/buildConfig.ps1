...
# Base name of the packaged file: <AddinFileBase>_<version>_<state>.jmpaddin
$AddinFileBase = "JMPScriptingTools"

$NaturalDocsExe = "C:\Program Files (x86)\Natural Docs\NaturalDocs.exe"
$JmpExe         = "$Env:ProgramFiles\JMP\JMPPRO\19\jmp.exe"

# JMP versions to run unit tests against in the Release preset.
